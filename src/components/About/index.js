  ...
  return (
    ...
    <div className="container about-page">
      <div className="text-zone">
        ...
        <p align="LEFT" >
         Proficient in <span style={{color:'yellow'}}>HTML, CSS, JavaScript, jQuery, Bootstrap, Sass, React.js, Next.js etc</span>. I have a good sense of aesthetics
         and experience in responsive, mobile-first web design, eager to contribute to the development of innovative web solutions.
        </p>
        <p>
